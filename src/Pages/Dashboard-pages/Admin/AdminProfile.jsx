...
export default function ProfileCard() {
  ...
  return (
    <div className="flex max-w-[600px] mx-auto mt-5 flex-col items-center justify-center space-y-4 rounded-xl bg-white p-8 shadow-lg dark:bg-[#18181B]">
      <Helmet>
      ...
      <div className="space-y-1 text-center">
        <h1 className="text-2xl text-gray-700 dark:text-white/90 pb-2">
          {user?.displayName}
        </h1>
        <p className="text-sm text-gray-400">Email : {user?.email}</p>
        <p className="text-sm text-gray-400">Role : {role}</p>
        <p className="text-sm text-gray-400">Total Rooms : {stats?.totalApartment}</p>
        <p className="text-sm text-gray-400">Total User : {stats?.totalUser}</p>
        <p className="text-sm text-gray-400">Total Member : {stats?.totalMember}</p>
      </div>
...
//     console.log(user);
//     return (
//         <div className="flex flex-col items-center justify-center md:flex-row mt-6">
