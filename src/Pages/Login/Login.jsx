...
const Login = () => {
    ...
    <div className='w-full flex justify-center items-center z-0 p-4 gap-10 flex-col lg:flex-row  shadow border mx-auto  dark:bg-gray-50 dark:text-gray-800'>
    <div className="">
            <img src={loginPhoto} className="max-w-sm rounded-lg shadow-2xl" alt='' />
        </div>
	...
	<form noValidate="" action="" className="space-y-8">
		...
		<button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-violet-600 dark:text-gray-50">Sign in</button>
	</form>
        </div>
